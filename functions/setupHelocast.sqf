...
[_helo, ["Helocast", "call fatlurch_fnc_helocast",nil,10, false, false, "","(_target getVariable 'readyHelocast')&&((getPosASL _target select 2) >0.5) &&((getPosASL _target select 2) <4.5) && ((speed _target) <15) && isEngineOn _target && surfaceiswater position _target"]] remoteExec ["addAction",0, true];
