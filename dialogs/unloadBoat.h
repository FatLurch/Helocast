...
class unloadBoat
{
	...
	onUnload ="if((_this select 1==1) && (lbCurSel 200 != -1) && (lbCurSel 201 != -1)) then {[ctrlText 202 call BIS_fnc_objectFromNetId, lbData [200, lbCurSel 200] call BIS_fnc_objectFromNetId, call compile lbData [201, lbCurSel 201]] call fatLurch_fnc_unloadBoat;};";
